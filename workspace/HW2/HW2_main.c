...
//        DataToLabView.floatData[7] = (float)numTimer0calls*5.0;
        ...
        DataToLabView.floatData[0] = fromLVvalues[0];
        DataToLabView.floatData[1] = fromLVvalues[1];
        DataToLabView.floatData[2] = fromLVvalues[2];
        DataToLabView.floatData[3] = fromLVvalues[3];
        DataToLabView.floatData[4] = fromLVvalues[4];
        DataToLabView.floatData[5] = fromLVvalues[5];
        DataToLabView.floatData[6] = fromLVvalues[6];
        DataToLabView.floatData[7] = fromLVvalues[7];
